...
sheet_index = 6  # Sheet index in Google Sheets
...
sound0 = ps.Sound()
play_sound0 = sound0.run_once_sound(sound0.play_sound)
sound1 = ps.Sound()
play_sound1 = sound1.run_once_sound(sound1.play_sound)
sound2 = ps.Sound()
play_sound2 = sound2.run_once_sound(sound2.play_sound)

start_time = datetime.datetime.now().replace(microsecond=0)
print(start_time)


def hit_log(centers, distance0, distance1, distance2, hit0, time0, hit1, time1, hit2, time2):
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    while True:
        ...
        for c in contours:
            ...
            # centers, distance0, distance1, distance2, hit0, time0, hit1, time1, hit2, time2
            hit_log(centers_log, distance0, distance1, distance2, hit0, time0, hit1, time1, hit2, time2)
