        ...
        for c in contours:
            ...
            if len(centers) == 2:
                ...
                if abs(centers[1] - centers[0]) < distance0.distance(y0):
                    index0_1 = int(centers[0] / distance0.size_ratio(y0)) + distance0.led_y(centers[1])
                    index1_1 = int(centers[1] / distance0.size_ratio(y0))  # + distance0.led_y(centers[1])
                    hit0()
                    time0.has_run = False
                else:
                    index0_1 = 0
                ...
                if abs(centers[1] - centers[0]) < distance0.distance(y0):
                    index0_1 = int(centers[0] / distance0.size_ratio(y0))
                    index1_1 = int(centers[1] / distance0.size_ratio(y0))
                    hit0()
                    time0.has_run = False
                else:
                    index0_1 = 0
